					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control border-input" placeholder="Codigo" name="firstname" value="<?php echo $customer->firstname; ?>" />
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="lastname">Apellidos</label>
								<input type="text" class="form-control border-input" placeholder="Descripción" name="lastname" value="<?php echo $customer->lastname; ?>" />
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control border-input" placeholder="Cedula" name="cedula" value="<?php echo $customer->cedula; ?>" />
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="cell_phone">Celular</label>
								<input type="text" class="form-control border-input" placeholder="Celular"  name="cell_phone" value="<?php echo $customer->cell_phone; ?>" />
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control border-input" placeholder="Correo" name="email" value="<?php echo $customer->email; ?>" />
								</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">

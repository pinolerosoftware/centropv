							...
							<div class="content">
								<form action="/productos/editar" method="post">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control border-input" placeholder="Codigo" name="codigo" value="<?php echo $product->codigo; ?>" />
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label for="lastname">Descripción</label>
												<input type="text" class="form-control border-input" placeholder="Descripción" name="descripcion" value="<?php echo $product->descripcion; ?>" />
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control border-input" placeholder="Codigo de barra" name="codigo_barra" value="<?php echo $product->codigo_barra; ?>" />
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label for="lastname">Precio</label>
												<input type="text" class="form-control border-input" placeholder="Precio" name="precio" value="<?php echo $product->precio; ?>" />
											</div>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="checkbox">
												<input id="service" name="service" type="checkbox" <?php echo ($product->service == 1)?"checked":""; ?> />
												<label for="service">
													Servicio
												</label>
											</div>
										...
										<div class="col-md-6">
											<div class="checkbox">
												<input id="taxFree" name="taxFree" type="checkbox" <?php echo ($product->taxFree == 1)?"checked":""; ?> />
												<label for="taxFree">
													Iva
												</label>
											</div>

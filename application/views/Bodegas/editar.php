...
<nav class="navbar navbar-default">
        ...
        <div class="content">
          ...
          <div class="col-lg-12 col-md-7">
						<div class="card">
							<div class="header">
              	<h4 class="title">Modificar Bodega</h4>
              </div>
							<div class="content">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" class="form-control border-input" placeholder="Ingrese la bodega" name="bodega" value="<?php echo $cellar->cellar; ?>">
											</div>
										</div>
									</div>
									<!--Boton de guardar-->

									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" class="form-control border-input" placeholder="Ingrese la bodega" name="marca" />
											</div>
										</div>
									</div>
									<!--Boton de guardar-->
		...
		<form action="/marcas/guardar" method="post">
			<div class="form-group row">
			  ...
			  <div class="col-xs-12 col-md-12">
			    <input class="form-control" type="text" placeholder="Ingrese la marca" name="marca">
			  </div>
			</div>
			<div class="form-group row">				
		      	<div class="center">
